...
const Home = () => {
  ...
  if (loading) {
    return <Loading height={"100vh"} my={"auto"} size={150} />;
  }
  ...
  return (
    <div>
      ...
      <div className="banner banner-size ps-5">
        <h1>
          AVIATOR <br /> VERRES ICEBERG <br /> GLASSES
        </h1>
      ...
      <div className="container">
        <div className="my-5 text-center">
          <h1 className="fw-bold">
            MOST POPULAR <span className="text-color">PRODUCTS</span>{" "}
          </h1>
      ...
      <div className="container">
        <div className="my-5 text-center">
          <h1 className="fw-bold">
            CUSTOMER <span className="text-color">REVIEWS</span>
          </h1>
